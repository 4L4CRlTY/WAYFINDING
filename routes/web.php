...
Route::middleware(['auth', 'roles:authorized_user'])->group(function () {
    Route::get('/authorized/dashboard', [AuthorizedUserController::class, 'dashboard'])->name('authorized.dashboard');
    Route::post('/authorized/logout', [AuthorizedUserController::class, 'logout'])->name('authorized.logout');
});
...
Route::middleware(['auth', 'roles:admin,authorized_user', 'invalidate.wayfinding'])->group(function () {
    ...
    Route::middleware('authorized.feature:hazard_points')->group(function () {
    ...
    Route::middleware('authorized.feature:entry_points')->group(function () {
    ...
    Route::middleware('authorized.feature:land_use')->group(function () {
    ...
    Route::middleware('authorized.feature:building_entrances')->group(function () {
    ...
    Route::middleware('authorized.feature:indoor_maps')->group(function () {
    ...
    Route::middleware('authorized.feature:indoor_rooms')->group(function () {
    ...
    Route::middleware('authorized.feature:indoor_paths')->group(function () {
    ...
    Route::middleware('authorized.feature:indoor_entrances')->group(function () {
    ...
    Route::middleware('authorized.feature:stairs_links')->group(function () {
    ...
    Route::middleware('authorized.feature:entrance_links')->group(function () {
    ...
    Route::middleware('authorized.feature:campus_events')->group(function () {
